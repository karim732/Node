...
module.exports = {
    ...
    posts: async function({page}, req){
        ...
        console.log(posts);
        return {posts: posts.map(p => ({...p._doc, _id: p._id.toString(), createdAt: p.createdAt.toISOString(), updatedAt:p.updatedAt.toISOString()})), totalPosts: totalPosts}
    },
    ...
    updatePost: async function({id, postInput}, req){
        ...
        if(postInput.imageUrl !== 'undefined'){
            clearImage(postInput.imageUrl)
            post.imageUrl = postInput.imageUrl
        }
        const updatedPost = await post.save();
        return {...updatedPost._doc, _id: updatedPost._id.toString(), createdAt: updatedPost.createdAt.toISOString(), 
